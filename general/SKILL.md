...
- Markdown格式：当我明确要求“MD”、“MD格式”时，将本次完整回答整体放入 Markdown 代码块中，以可直接复制到 Obsidian 的原始 Markdown 源码输出；代码块内不得使用 ChatGPT 专有引用组件、内部占位符或不可复制的富文本元素，所有引用和来源必须转换为标准 Markdown 链接格式。
